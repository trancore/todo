...
| 6                    | サインインしている   | -        | TODO を編集する。                    |
| 7                    | サインインしている   | -        | TODO を完了する。                    |
| 8                    | サインインしている   | -        | TODO 完了画面を開く。                |
| 9                    | サインインしている   | -        | TODO を削除する。                    |
| 10                   | サインインしている   | -        | サインアウトする。                   |
...
これを行うことによって、処理一つ一つが独立することで assetion をを判別しやすくなり、
